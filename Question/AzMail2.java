...
class AzMail2 {
  ...
  public static void main(String argv[]) throws Exception {
    String user = "s2010876149@ru.ac.bd";
    String pass = "Z29wYWxnb25qZGhha2E=";
    ...
    send("MAIL FROM:<s2010876149@ru.ac.bd>\r\n");
              System.out.println("SERVER: "+ br.readLine());


    send("RCPT TO:<uttamsarkar678@gmail.com>\r\n");
              System.out.println("SERVER: "+ br.readLine());
    ...
    send("FROM: s2010876149@ru.ac.bd\r\n");
    send("TO: uttamsarkar678@gmail.com\r\n");
